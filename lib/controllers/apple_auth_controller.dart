    ...
    try {
      ...
      final appleCredential = await SignInWithApple.getAppleIDCredential(
        ...
        webAuthenticationOptions: WebAuthenticationOptions(
          clientId: 'com.example.project_auth.service', // Replace with your Service ID
          redirectUri: Uri.parse(
            'https://flutter-auth-test-221cb.firebaseapp.com/__/auth/handler', // Replace with your Redirect URI
          ),
        ),
      );
